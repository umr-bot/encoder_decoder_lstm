...
from utils import batch, datagen, decode_sequences, datagen_bahdanau
...
# Compile the model.
#model = seq2seq_bahdanau(hidden_size, nb_input_chars, nb_target_chars)
...
#    print('-')
    ...
    save_dir = 'eng_luong_checkpoints_fold' + str(fold_num)
