...
from test_model import seq2seq
...
for epoch in range(model_cnt,100):
    ...
    #train_encoder_2, train_decoder_2, train_target_2 = transform2( train_tokens[st_ind:et_ind], maxlen, shuffle=False, dec_tokens=train_dec_tokens[st_ind:et_ind])
    ...
    #val_encoder_2, val_decoder_2, val_target_2 = transform2( val_tokens[sv_ind:ev_ind], maxlen, shuffle=False, dec_tokens=val_dec_tokens[sv_ind:ev_ind])
    ...
    train_loader = datagen_triplet(train_encoder_batch,
                           train_decoder_batch, train_target_batch)
    val_loader = datagen_triplet(val_encoder_batch,
